...
fun main(): Unit = runBlocking {
    ...
    val registrationRequestExchange = RabbitExchange(
        ...
        name = "registration-request-x-consistent-exchange",
    ...
    connectionFactory.declareAndBind(exchange = registrationRequestExchange, queue = registrationRequestQueue, routingKey = System.getenv("REGISTRATION_REQUEST_ROUTING_KEY") ?: "42")
